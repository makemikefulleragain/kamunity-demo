      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-sm text-blue-800">
                      ...
                      volunteer coordination, and grant applications.
                    </p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <p className="text-sm text-green-900 font-medium mb-2">🎯 Suggested Actions</p>
                    <ul className="text-sm text-green-800 space-y-1">
                      <li>• Review pending resource uploads</li>
                      <li>• Connect with new members</li>
                      <li>• Document this week's progress</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            {/* Impact Metrics */}
            <div className="mt-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-purple-600">450kg</p>
                  <p className="text-sm text-gray-600">Produce Grown</p>
                </div>
                <div>
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800 text-center">
                ...
                Real rooms would have live interactions and member collaboration.
              </p>
            </div>
          </div>
        </div>
