...
import { ArrowLeft, Users, MessageSquare, Activity, Clock, Bot, Play, Pause, TrendingUp, Eye } from 'lucide-react'
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="bg-white/80 rounded-lg p-3">
                  <p className="font-medium text-purple-900 mb-1">Trending Topic</p>
                  <p className="text-gray-700">Soil preparation techniques are gaining traction with 5 new discussions today.</p>
                </div>
                <div className="bg-white/80 rounded-lg p-3">
                  <p className="font-medium text-purple-900 mb-1">Collaboration Opportunity</p>
                  <p className="text-gray-700">3 members have complementary skills in irrigation systems.</p>
                </div>
                <div className="bg-white/80 rounded-lg p-3">
                  <p className="font-medium text-purple-900 mb-1">Next Milestone</p>
                  <p className="text-gray-700">Community is 80% ready for the spring planting event.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Volunteers Engaged</span>
