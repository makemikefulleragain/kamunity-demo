...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary Brand Colors (kamunity.org inspired)
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Neutral Scale (High contrast for accessibility)
        neutral: {
          50: '#fafafa',
          100: '#f5f5f5',
          200: '#e5e5e5',
        ...
        // Legacy Kamunity colors for backward compatibility
        'kamunity-indigo': '#4F46E5',
        'kamunity-gold': '#F59E0B',
        'kamunity-lavender': '#A78BFA',
        'kamunity-peach': '#FB7185',
        'kamunity-charcoal': '#374151',
      },
      fontFamily: {
