    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8fafc;">
      <div style="background: white; border-radius: 12px; padding: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #10b981; padding-bottom: 20px;">
          <h1 style="color: #10b981; margin: 0; font-size: 28px;">Your ${o?"Focus Room Generator":"Saved Room"} 🎯</h1>
        ...
        <div style="background: #dbeafe; padding: 20px; border-radius: 8px; margin-bottom: 25px; border-left: 4px solid #3b82f6; text-align: center;">
          ...
          <a href="https://kamunitydemo.org/rooms/${t}" style="display: inline-block; background: #3b82f6; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">
